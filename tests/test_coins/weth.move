...
module razor_libs::weth_token {
    ...
    public fun weth_token_address(): address {
        object::create_object_address(&@razor_libs, ASSET_SYMBOL)
    }
    ...
    fun init_module(admin: &signer) {
        ...
        primary_fungible_store::create_primary_store_enabled_fungible_asset(
            ...
            utf8(ASSET_SYMBOL),
            DECIMALS,
            utf8(b"https://ipfs.io/ipfs/QmUofuPhv74Swgkt5JCoZKM6Aipnp5iEnddHfzis5CRnxM"),
            utf8(b"https://razordex.xyz"),
        );
