module razor_libs::i32 {
    ...
    public fun from(v: u32): I32 {
        assert!(v <= MAX_AS_U32, ERROR_OVERFLOW);
        I32 {
            bits: v
        }
    }
    ...
    public fun neg_from(v: u32): I32 {
        assert!(v <= MIN_AS_U32, ERROR_OVERFLOW);
        if (v == 0) {
            I32 {
                bits: v
            }
    ...
    public fun add(num1: I32, num2: I32): I32 {
        ...
        assert!(overflow == 0, ERROR_OVERFLOW);
        sum
    }
    ...
    public fun abs(v: I32): I32 {
        if (sign(v) == 0) {
            ...
            assert!(v.bits > MIN_AS_U32, ERROR_OVERFLOW);
            I32 {
